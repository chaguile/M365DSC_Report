...
| **2. Generar consulta** | Te guía a [export.microsoft365dsc.com](https://export.microsoft365dsc.com/) para generar `ConfigurationFile.ps1` con los componentes a exportar. En este caso debes elegir la opción Authentication --- Certificate <img width="1700" height="388" alt="image" src="https://github.com/user-attachments/assets/5087fa8f-2f57-4d1d-8ce9-e3ca27739a0c" /> |
...
El reporte **permite el uso de la propia marca (whitelabeling)**. El paso 7 (Generar reporte)
**pregunta la marca por pantalla**:
